...
?>
          ...
          $pricemax = $_GET['pricemax'];
            ...
            $request->execute([$city, $squaremin, $squaremax, $rooms, $pricemax]);
          ...
          ?>
          <div class="col-md-12">
            <a href="property-grid.php"><button type="submit" class="btn btn-b back-grid">Revoir tous les biens</button></a>
          </div>
          </div>
        </div>
        <div class="row">
